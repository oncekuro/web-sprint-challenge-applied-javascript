...
DOM is Document Object Model, it is everything on the webpage.

2. What is an event?

An event is something that happens when you do a certain interaction on the webpage

3. What is an event listener?

Its for the webpage to listen for a scroll or click then it performs an event
...
a small reusable function or behaivor
